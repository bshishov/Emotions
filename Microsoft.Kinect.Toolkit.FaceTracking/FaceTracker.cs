...
namespace Microsoft.Kinect.Toolkit.FaceTracking
{
    ...
    public class FaceTracker : IDisposable
    {
        ...
        public FaceTracker(KinectSensor sensor)
        {
            ...
            this._mapper = sensor.CoordinateMapper;
        ...
        public FaceTracker(ColorImageFormat colorImageFormat, int colorFrameWidth, int colorFrameHeight, float colorFocalLength, DepthImageFormat depthImageFormat, int depthFrameWidth, int depthFrameHeight, float depthFocalLength, CoordinateMapper mapper)
        {
            this.operationMode = OperationMode.Kinect;
            _mapper = mapper;
            this.initializationColorImageFormat = colorImageFormat;
            this.initializationDepthImageFormat = depthImageFormat;
            ...
            out int colorY)
        {
            ...
            if (_mapper != null)
            {
                ...
                try
                {
                    var depthImagePoint = new DepthImagePoint()
                    {
                        X = depthX,
                        Y = depthY,
                        Depth = depthZ,
                    ...
                    colorPoint = _mapper.MapDepthPointToColorPoint(
                        initializationDepthImageFormat,
                        depthImagePoint,
                        initializationColorImageFormat);                    
                    /*colorPoint = new ColorImagePoint()
                    {
                        X = depthImagePoint.X,
                        Y = depthImagePoint.Y
                    };*/
            ...
            FaceTrackingRegisterDepthToColor newRegisterDepthToColorDelegate)
        {
            ...
            //var callBack = new FaceTrackingRegisterDepthToColor(this.DepthToColorCallback);
